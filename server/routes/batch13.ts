...
const API_ENDPOINTS = [
  { method: 'GET', path: '/api/campaigns', description: 'List own campaigns', auth: 'firebase' },
  { method: 'POST', path: '/api/campaigns', description: 'Create draft campaign', auth: 'firebase' },
  { method: 'POST', path: '/api/payments/confirm', description: 'Confirm LN payment & activate campaign', auth: 'firebase' },
  { method: 'GET', path: '/api/metrics', description: 'Aggregate campaign metrics', auth: 'none' },
  { method: 'POST', path: '/api/lightning/invoice', description: 'Create BOLT11 invoice', auth: 'firebase' },
  { method: 'GET', path: '/api/lightning/info', description: 'Lightning node info (redacted)', auth: 'firebase' },
  { method: 'POST', path: '/api/marketplace/bid', description: 'Place marketplace bid', auth: 'firebase' },
  { method: 'POST', path: '/api/publisher/settings', description: 'Save publisher payout settings', auth: 'firebase' },
  { method: 'POST', path: '/api/settle', description: 'Withdraw (requires ENABLE_LN_PAYOUTS)', auth: 'firebase+flag' },
  { method: 'GET', path: '/api/settlements', description: 'Own settlement history', auth: 'firebase' },
  { method: 'POST', path: '/api/agent/campaigns', description: 'Agent: create draft campaign', auth: 'agent' },
  { method: 'GET', path: '/api/agent/metrics', description: 'Agent: fetch metrics', auth: 'agent' },
  { method: 'POST', path: '/api/agent/topup', description: 'Agent: Lightning top-up', auth: 'admin+ENABLE_LN_PAYOUTS' },
  ...
  { method: 'GET', path: '/api/wallet/balances', description: 'Wallet balance summary (demo unless ENABLE_LN_PAYOUTS)', auth: 'none' },
