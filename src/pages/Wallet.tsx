...
import { Zap, ArrowDownCircle, ArrowUpCircle, Copy, CheckCircle2, QrCode, X, Shield, Bitcoin } from "lucide-react";
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <StatCard icon={Zap} label="Lightning" value={balance !== null ? balance.toLocaleString() : '—'} sub="sats" color="text-lightning" />
            ...
            <Card className="glass-panel p-6">
              ...
              <div className="space-y-3 mt-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className={`font-bold flex items-center gap-1.5 ${nodeOnline ? 'text-green' : 'text-lightning'}`}>
                    <span className={`w-1.5 h-1.5 rounded-full ${nodeOnline ? 'bg-green animate-pulse' : 'bg-lightning'}`} />
                    {nodeOnline ? 'Online' : 'Demo'}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
          ...
          {invoice && (
            ...
            >
              <Card className="glass-panel p-6">
                ...
                <div className="flex gap-3">
                  <Button variant="secondary" size="sm" className="flex-1 gap-2" onClick={handleCopy}>
                  ...
                  <Button
                    ...
                    onClick={() => { if (invoice) window.open(`lightning:${invoice}`, '_blank'); }}
                  >
